...
[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D5CF0CC65A11D9")]
[System.ComponentModel.ToolboxItemAttribute(false)]
public sealed class ACMESearchSystem : OpenSpan.Adapters.Web.WebAdapter
{
	
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D5CF0CC65A11D9\\ActiveXFactory-8D5CF0E02F762B1")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D5CF0CC65A11D9\\WinInetFactory-8D5CF0E03496966")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D5CF0CC65A11D9\\MicrosoftHTMLFactory-8D5CF0E06DCF5FF")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D5CF0CC65A11D9\\WebPage-8D5CF0E1687AE9F")]
	public OpenSpan.Adapters.Web.Controls.WebPage ACMEwpSignIn;
	
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D5CF0CC65A11D9\\Form-8D5CF0E1676FE24")]
	public OpenSpan.Adapters.Web.Controls.Form ACMEfrmCredentials;
	
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D5CF0CC65A11D9\\TextBox-8D5CF0E164E781B")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D5CF0CC65A11D9\\TextBox-8D5CF0E1957F17B")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D5CF0CC65A11D9\\Button-8D5CF0E25D0D3DA")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D5CF0CC65A11D9\\WebPage-8D5CF0E377B0BA3")]
	public OpenSpan.Adapters.Web.Controls.WebPage ACMEwpHome;
	
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D5CF0CC65A11D9\\Link-8D5CF0E376A08B1")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D5CF0CC65A11D9\\WebControl-8D5CFE90F58139E")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D5CF0CC65A11D9\\WebPage-8D5CF0E446DA3CD")]
	public OpenSpan.Adapters.Web.Controls.WebPage ACMEwpStores;
	
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D5CF0CC65A11D9\\Form-8D5CF0E445F55B4")]
	public OpenSpan.Adapters.Web.Controls.Form ACMEfrmSearch;
	
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D5CF0CC65A11D9\\TextBox-8D5CF0E44477E1E")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D5CF0CC65A11D9\\Button-8D5CF0E46DD2787")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D5CF0CC65A11D9\\WebPage-8D5CF0F51FA0E84")]
	public OpenSpan.Adapters.Web.Controls.WebPage ACMEwpResults;
	
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D5CF0CC65A11D9\\Form-8D5CF0F51EE22B1")]
	public OpenSpan.Adapters.Web.Controls.Form Peachtree_City2715_Hwy_54_WPeachtr1;
	
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D5CF0CC65A11D9\\Table-8D5CF0F51E2370F")]
	public OpenSpan.Adapters.Web.Controls.Table Peachtree_City2715_Hwy_54_WPeachtre;
	...
	public ACMESearchSystem()
	{
		...
		this.Peachtree_City2715_Hwy_54_WPeachtr1 = new OpenSpan.Adapters.Web.Controls.Form();
		this.Peachtree_City2715_Hwy_54_WPeachtre = new OpenSpan.Adapters.Web.Controls.Table();
		...
		// 
		this.Id = new OpenSpan.Design.ComponentIdentity("WebAdapter-8D5CF0CC65A11D9");
		// 
		// Set component Ids
		// 
		this.SetId(this.ActiveXFactory, new OpenSpan.Design.ComponentIdentity("ActiveXFactory-8D5CF0E02F762B1"));
		this.SetId(this.moduleNameMatchRule1, new OpenSpan.Design.ComponentIdentity("ModuleNameMatchRule-8D5CF0E030BEAD6"));
		this.SetId(this.WinInetFactory, new OpenSpan.Design.ComponentIdentity("WinInetFactory-8D5CF0E03496966"));
		this.SetId(this.moduleNameMatchRule2, new OpenSpan.Design.ComponentIdentity("ModuleNameMatchRule-8D5CF0E035A1B09"));
		this.SetId(this.MicrosoftHTMLFactory, new OpenSpan.Design.ComponentIdentity("MicrosoftHTMLFactory-8D5CF0E06DCF5FF"));
		this.SetId(this.moduleNameMatchRule3, new OpenSpan.Design.ComponentIdentity("ModuleNameMatchRule-8D5CF0E06F99283"));
		this.SetId(this.ACMEwpSignIn, new OpenSpan.Design.ComponentIdentity("WebPage-8D5CF0E1687AE9F"));
		this.SetId(this.ACMEfrmCredentials, new OpenSpan.Design.ComponentIdentity("Form-8D5CF0E1676FE24"));
		this.SetId(this.ACMEtxtUserName, new OpenSpan.Design.ComponentIdentity("TextBox-8D5CF0E164E781B"));
		this.SetId(this.inputTypeMatchRule1, new OpenSpan.Design.ComponentIdentity("InputTypeMatchRule-8D5CF0E16E65B71"));
		this.SetId(this.attributeMatchRule1, new OpenSpan.Design.ComponentIdentity("AttributeMatchRule-8D5CFE8584BB1CD"));
		this.SetId(this.ACMEtxtPassword, new OpenSpan.Design.ComponentIdentity("TextBox-8D5CF0E1957F17B"));
		this.SetId(this.inputTypeMatchRule2, new OpenSpan.Design.ComponentIdentity("InputTypeMatchRule-8D5CF0E19748DC2"));
		this.SetId(this.elementIdMatchRule2, new OpenSpan.Design.ComponentIdentity("ElementIdMatchRule-8D5CF0E198A1E5A"));
		this.SetId(this.ACMEbtnSignin, new OpenSpan.Design.ComponentIdentity("Button-8D5CF0E25D0D3DA"));
		this.SetId(this.inputTypeMatchRule3, new OpenSpan.Design.ComponentIdentity("InputTypeMatchRule-8D5CF0E25ED707B"));
		this.SetId(this.elementIdMatchRule3, new OpenSpan.Design.ComponentIdentity("ElementIdMatchRule-8D5CF0E25FE20B4"));
		this.SetId(this.formActionMatchRule1, new OpenSpan.Design.ComponentIdentity("FormActionMatchRule-8D5CF0E16C9BF22"));
		this.SetId(this.documentUrlMatchRule1, new OpenSpan.Design.ComponentIdentity("DocumentUrlMatchRule-8D5CF0E169B2D1D"));
		this.SetId(this.documentTitleMatchRule1, new OpenSpan.Design.ComponentIdentity("DocumentTitleMatchRule-8D5CF0E16ABDDA9"));
		this.SetId(this.ACMEwpHome, new OpenSpan.Design.ComponentIdentity("WebPage-8D5CF0E377B0BA3"));
		this.SetId(this.ACMElnkStores, new OpenSpan.Design.ComponentIdentity("Link-8D5CF0E376A08B1"));
		this.SetId(this.innerTextMatchRule1, new OpenSpan.Design.ComponentIdentity("InnerTextMatchRule-8D5CF0E37C8C008"));
		this.SetId(this.ACMENewsAlert, new OpenSpan.Design.ComponentIdentity("WebControl-8D5CFE90F58139E"));
		this.SetId(this.elementIndexMatchRule1, new OpenSpan.Design.ComponentIdentity("ElementIndexMatchRule-8D5CFE93A719D40"));
		this.SetId(this.documentUrlMatchRule2, new OpenSpan.Design.ComponentIdentity("DocumentUrlMatchRule-8D5CF0E378D2510"));
		this.SetId(this.documentTitleMatchRule2, new OpenSpan.Design.ComponentIdentity("DocumentTitleMatchRule-8D5CF0E3799110C"));
		this.SetId(this.ACMEwpStores, new OpenSpan.Design.ComponentIdentity("WebPage-8D5CF0E446DA3CD"));
		this.SetId(this.ACMEfrmSearch, new OpenSpan.Design.ComponentIdentity("Form-8D5CF0E445F55B4"));
		this.SetId(this.ACMEtxtZip, new OpenSpan.Design.ComponentIdentity("TextBox-8D5CF0E44477E1E"));
		this.SetId(this.inputTypeMatchRule4, new OpenSpan.Design.ComponentIdentity("InputTypeMatchRule-8D5CF0E44C11A49"));
		this.SetId(this.elementIdMatchRule5, new OpenSpan.Design.ComponentIdentity("ElementIdMatchRule-8D5CF0E44DB5484"));
		this.SetId(this.ACMEbtnFindStore, new OpenSpan.Design.ComponentIdentity("Button-8D5CF0E46DD2787"));
		this.SetId(this.inputTypeMatchRule5, new OpenSpan.Design.ComponentIdentity("InputTypeMatchRule-8D5CF0E46F2E2D4"));
		this.SetId(this.elementIdMatchRule6, new OpenSpan.Design.ComponentIdentity("ElementIdMatchRule-8D5CF0E47022064"));
		this.SetId(this.elementIdMatchRule4, new OpenSpan.Design.ComponentIdentity("ElementIdMatchRule-8D5CF0E44A76465"));
		this.SetId(this.documentUrlMatchRule3, new OpenSpan.Design.ComponentIdentity("DocumentUrlMatchRule-8D5CF0E447E544D"));
		this.SetId(this.documentTitleMatchRule3, new OpenSpan.Design.ComponentIdentity("DocumentTitleMatchRule-8D5CF0E448F04DD"));
		this.SetId(this.ACMEwpResults, new OpenSpan.Design.ComponentIdentity("WebPage-8D5CF0F51FA0E84"));
		this.SetId(this.Peachtree_City2715_Hwy_54_WPeachtr1, new OpenSpan.Design.ComponentIdentity("Form-8D5CF0F51EE22B1"));
		this.SetId(this.Peachtree_City2715_Hwy_54_WPeachtre, new OpenSpan.Design.ComponentIdentity("Table-8D5CF0F51E2370F"));
		this.SetId(this.elementIdMatchRule8, new OpenSpan.Design.ComponentIdentity("ElementIdMatchRule-8D5CF0F522ED3F6"));
		this.SetId(this.elementIdMatchRule7, new OpenSpan.Design.ComponentIdentity("ElementIdMatchRule-8D5CF0F522085D5"));
		this.SetId(this.documentUrlMatchRule4, new OpenSpan.Design.ComponentIdentity("DocumentUrlMatchRule-8D5CF0F5204FF48"));
		this.SetId(this.documentTitleMatchRule4, new OpenSpan.Design.ComponentIdentity("DocumentTitleMatchRule-8D5CF0F5212378E"));
		// 
		// ACMESearchSystem
		// 
		...
		// 
		this.formActionMatchRule1.Fragment = textmatchdata7;
		textmatchdata8.Text = "training.openspan.com";
		this.formActionMatchRule1.Host = textmatchdata8;
		textmatchdata9.Text = "/home";
		this.formActionMatchRule1.Path = textmatchdata9;
		this.formActionMatchRule1.Port = 80;
		this.formActionMatchRule1.Query = textmatchdata10;
		textmatchdata11.Text = "http";
		this.formActionMatchRule1.Scheme = textmatchdata11;
		...
		// 
		this.documentUrlMatchRule1.Fragment = textmatchdata12;
		textmatchdata13.Text = "training.openspan.com";
		this.documentUrlMatchRule1.Host = textmatchdata13;
		textmatchdata14.Text = "/login";
		this.documentUrlMatchRule1.Path = textmatchdata14;
		this.documentUrlMatchRule1.Port = 80;
		this.documentUrlMatchRule1.Query = textmatchdata15;
		textmatchdata16.Text = "http";
		this.documentUrlMatchRule1.Scheme = textmatchdata16;
		// 
		// documentTitleMatchRule1
		// 
		textmatchdata17.Text = "Sign In | Pega Studio Training Web Application";
		this.documentTitleMatchRule1.Text = textmatchdata17;
		...
		// innerTextMatchRule1
		// 
		textmatchdata18.Text = "Stores";
		this.innerTextMatchRule1.Text = textmatchdata18;
		...
		// 
		this.documentUrlMatchRule2.Fragment = textmatchdata19;
		textmatchdata20.Text = "training.openspan.com";
		this.documentUrlMatchRule2.Host = textmatchdata20;
		textmatchdata21.Text = "/home";
		this.documentUrlMatchRule2.Path = textmatchdata21;
		this.documentUrlMatchRule2.Port = 80;
		this.documentUrlMatchRule2.Query = textmatchdata22;
		textmatchdata23.Text = "http";
		this.documentUrlMatchRule2.Scheme = textmatchdata23;
		// 
		// documentTitleMatchRule2
		// 
		textmatchdata24.Text = "Home | Pega Studio Training Web Application";
		this.documentTitleMatchRule2.Text = textmatchdata24;
		...
		// elementIdMatchRule5
		// 
		textmatchdata25.Text = "txtZip";
		this.elementIdMatchRule5.Text = textmatchdata25;
		...
		// elementIdMatchRule6
		// 
		textmatchdata26.Text = "submit_find";
		...
		// elementIdMatchRule4
		// 
		textmatchdata27.Text = "form1";
		this.elementIdMatchRule4.Text = textmatchdata27;
		...
		// 
		this.documentUrlMatchRule3.Fragment = textmatchdata28;
		textmatchdata29.Text = "training.openspan.com";
		this.documentUrlMatchRule3.Host = textmatchdata29;
		textmatchdata30.Text = "/store_locator";
		this.documentUrlMatchRule3.Path = textmatchdata30;
		this.documentUrlMatchRule3.Port = 80;
		this.documentUrlMatchRule3.Query = textmatchdata31;
		textmatchdata32.Text = "http";
		this.documentUrlMatchRule3.Scheme = textmatchdata32;
		// 
		// documentTitleMatchRule3
		// 
		textmatchdata33.Text = "Stores | Pega Studio Training Web Application";
		this.documentTitleMatchRule3.Text = textmatchdata33;
		...
		// 
		// 
		// Peachtree_City2715_Hwy_54_WPeachtr1
		// 
		// 
		// Peachtree_City2715_Hwy_54_WPeachtre
		// 
		this.Peachtree_City2715_Hwy_54_WPeachtre.ElementId = "search_locator_result_table";
		this.Peachtree_City2715_Hwy_54_WPeachtre.Extender = null;
		this.Peachtree_City2715_Hwy_54_WPeachtre.ForwardObjectExplorerEvent = true;
		this.Peachtree_City2715_Hwy_54_WPeachtre.MatchingIndex = 0;
		// 
		// elementIdMatchRule8
		// 
		textmatchdata34.Text = "search_locator_result_table";
		this.elementIdMatchRule8.Text = textmatchdata34;
		this.Peachtree_City2715_Hwy_54_WPeachtre.MatchRules.Add(this.elementIdMatchRule8);
		this.Peachtree_City2715_Hwy_54_WPeachtre.Name = "Peachtree_City2715_Hwy_54_WPeachtre";
		this.Peachtree_City2715_Hwy_54_WPeachtre.Schema.Id = new System.Guid("820b285d-efbd-4d0e-a63b-04bb121441d5");
		this.Peachtree_City2715_Hwy_54_WPeachtre.Schema.Name = "Peachtree_City2715_Hwy_54_WPeachtre";
		this.Peachtree_City2715_Hwy_54_WPeachtre.TagName = "TABLE";
		this.Peachtree_City2715_Hwy_54_WPeachtre.TargetTypeString = "OpenSpan.Adapters.Web.HtmlTableElement, OpenSpan.Adapters.Web";
		this.Peachtree_City2715_Hwy_54_WPeachtre.UseElementId = true;
		this.Peachtree_City2715_Hwy_54_WPeachtr1.Controls.Add(this.Peachtree_City2715_Hwy_54_WPeachtre);
		this.Peachtree_City2715_Hwy_54_WPeachtr1.ElementId = "form1";
		this.Peachtree_City2715_Hwy_54_WPeachtr1.Extender = null;
		this.Peachtree_City2715_Hwy_54_WPeachtr1.ForwardObjectExplorerEvent = true;
		this.Peachtree_City2715_Hwy_54_WPeachtr1.MatchingIndex = 0;
		// 
		// elementIdMatchRule7
		// 
		textmatchdata35.Text = "form1";
		this.elementIdMatchRule7.Text = textmatchdata35;
		this.Peachtree_City2715_Hwy_54_WPeachtr1.MatchRules.Add(this.elementIdMatchRule7);
		this.Peachtree_City2715_Hwy_54_WPeachtr1.Name = "Peachtree_City2715_Hwy_54_WPeachtr1";
		this.Peachtree_City2715_Hwy_54_WPeachtr1.TagName = "FORM";
		this.Peachtree_City2715_Hwy_54_WPeachtr1.TargetTypeString = "OpenSpan.Adapters.Web.HtmlFormElement, OpenSpan.Adapters.Web";
		this.Peachtree_City2715_Hwy_54_WPeachtr1.UseElementId = true;
		this.ACMEwpResults.Controls.Add(this.Peachtree_City2715_Hwy_54_WPeachtr1);
		...
		this.Components.Add(this.Peachtree_City2715_Hwy_54_WPeachtr1);
		this.Components.Add(this.Peachtree_City2715_Hwy_54_WPeachtre);
	...
	internal OpenSpan.Adapters.ActiveX.ActiveXFactory Create_ActiveXFactory(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(ActiveXFactory, new OpenSpan.Design.ComponentIdentity("ActiveXFactory-8D5CF0E02F762B1"));
		...
		// Set designComp Ids
		// 
		this.SetId(moduleNameMatchRule1, new OpenSpan.Design.ComponentIdentity("ModuleNameMatchRule-8D5CF0E030BEAD6"));
		// 
		// Add components
		// 
	...
	internal OpenSpan.Adapters.WinInet.WinInetFactory Create_WinInetFactory(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(WinInetFactory, new OpenSpan.Design.ComponentIdentity("WinInetFactory-8D5CF0E03496966"));
		...
		// Set designComp Ids
		// 
		this.SetId(moduleNameMatchRule2, new OpenSpan.Design.ComponentIdentity("ModuleNameMatchRule-8D5CF0E035A1B09"));
		// 
		// Add components
		// 
	...
	internal OpenSpan.Adapters.Web.MicrosoftHTMLFactory Create_MicrosoftHTMLFactory(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(MicrosoftHTMLFactory, new OpenSpan.Design.ComponentIdentity("MicrosoftHTMLFactory-8D5CF0E06DCF5FF"));
		...
		// Set designComp Ids
		// 
		this.SetId(moduleNameMatchRule3, new OpenSpan.Design.ComponentIdentity("ModuleNameMatchRule-8D5CF0E06F99283"));
		// 
		// Add components
		// 
	...
	internal OpenSpan.Adapters.Web.Controls.WebPage Create_ACMEwpSignIn(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(ACMEwpSignIn, new OpenSpan.Design.ComponentIdentity("WebPage-8D5CF0E1687AE9F"));
		...
		// 
		OpenSpan.Adapters.TextMatchData textmatchdata4 = new OpenSpan.Adapters.TextMatchData();
		formActionMatchRule1.Fragment = textmatchdata4;
		OpenSpan.Adapters.TextMatchData textmatchdata5 = new OpenSpan.Adapters.TextMatchData();
		textmatchdata5.Text = "training.openspan.com";
		formActionMatchRule1.Host = textmatchdata5;
		OpenSpan.Adapters.TextMatchData textmatchdata6 = new OpenSpan.Adapters.TextMatchData();
		textmatchdata6.Text = "/home";
		formActionMatchRule1.Path = textmatchdata6;
		formActionMatchRule1.Port = 80;
		OpenSpan.Adapters.TextMatchData textmatchdata7 = new OpenSpan.Adapters.TextMatchData();
		formActionMatchRule1.Query = textmatchdata7;
		OpenSpan.Adapters.TextMatchData textmatchdata8 = new OpenSpan.Adapters.TextMatchData();
		textmatchdata8.Text = "http";
		formActionMatchRule1.Scheme = textmatchdata8;
		...
		// 
		OpenSpan.Adapters.TextMatchData textmatchdata9 = new OpenSpan.Adapters.TextMatchData();
		documentUrlMatchRule1.Fragment = textmatchdata9;
		OpenSpan.Adapters.TextMatchData textmatchdata10 = new OpenSpan.Adapters.TextMatchData();
		textmatchdata10.Text = "training.openspan.com";
		documentUrlMatchRule1.Host = textmatchdata10;
		OpenSpan.Adapters.TextMatchData textmatchdata11 = new OpenSpan.Adapters.TextMatchData();
		textmatchdata11.Text = "/login";
		documentUrlMatchRule1.Path = textmatchdata11;
		documentUrlMatchRule1.Port = 80;
		OpenSpan.Adapters.TextMatchData textmatchdata12 = new OpenSpan.Adapters.TextMatchData();
		documentUrlMatchRule1.Query = textmatchdata12;
		OpenSpan.Adapters.TextMatchData textmatchdata13 = new OpenSpan.Adapters.TextMatchData();
		textmatchdata13.Text = "http";
		documentUrlMatchRule1.Scheme = textmatchdata13;
		...
		// 
		OpenSpan.Adapters.TextMatchData textmatchdata14 = new OpenSpan.Adapters.TextMatchData();
		textmatchdata14.Text = "Sign In | Pega Studio Training Web Application";
		documentTitleMatchRule1.Text = textmatchdata14;
		...
		// Set designComp Ids
		// 
		this.SetId(ACMEfrmCredentials, new OpenSpan.Design.ComponentIdentity("Form-8D5CF0E1676FE24"));
		this.SetId(ACMEtxtUserName, new OpenSpan.Design.ComponentIdentity("TextBox-8D5CF0E164E781B"));
		this.SetId(inputTypeMatchRule1, new OpenSpan.Design.ComponentIdentity("InputTypeMatchRule-8D5CF0E16E65B71"));
		this.SetId(attributeMatchRule1, new OpenSpan.Design.ComponentIdentity("AttributeMatchRule-8D5CFE8584BB1CD"));
		this.SetId(ACMEtxtPassword, new OpenSpan.Design.ComponentIdentity("TextBox-8D5CF0E1957F17B"));
		this.SetId(inputTypeMatchRule2, new OpenSpan.Design.ComponentIdentity("InputTypeMatchRule-8D5CF0E19748DC2"));
		this.SetId(elementIdMatchRule2, new OpenSpan.Design.ComponentIdentity("ElementIdMatchRule-8D5CF0E198A1E5A"));
		this.SetId(ACMEbtnSignin, new OpenSpan.Design.ComponentIdentity("Button-8D5CF0E25D0D3DA"));
		this.SetId(inputTypeMatchRule3, new OpenSpan.Design.ComponentIdentity("InputTypeMatchRule-8D5CF0E25ED707B"));
		this.SetId(elementIdMatchRule3, new OpenSpan.Design.ComponentIdentity("ElementIdMatchRule-8D5CF0E25FE20B4"));
		this.SetId(formActionMatchRule1, new OpenSpan.Design.ComponentIdentity("FormActionMatchRule-8D5CF0E16C9BF22"));
		this.SetId(documentUrlMatchRule1, new OpenSpan.Design.ComponentIdentity("DocumentUrlMatchRule-8D5CF0E169B2D1D"));
		this.SetId(documentTitleMatchRule1, new OpenSpan.Design.ComponentIdentity("DocumentTitleMatchRule-8D5CF0E16ABDDA9"));
		// 
		// Add components
		// 
	...
	internal OpenSpan.Adapters.Web.Controls.WebPage Create_ACMEwpHome(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(ACMEwpHome, new OpenSpan.Design.ComponentIdentity("WebPage-8D5CF0E377B0BA3"));
		...
		// Set designComp Ids
		// 
		this.SetId(ACMElnkStores, new OpenSpan.Design.ComponentIdentity("Link-8D5CF0E376A08B1"));
		this.SetId(innerTextMatchRule1, new OpenSpan.Design.ComponentIdentity("InnerTextMatchRule-8D5CF0E37C8C008"));
		this.SetId(ACMENewsAlert, new OpenSpan.Design.ComponentIdentity("WebControl-8D5CFE90F58139E"));
		this.SetId(elementIndexMatchRule1, new OpenSpan.Design.ComponentIdentity("ElementIndexMatchRule-8D5CFE93A719D40"));
		this.SetId(documentUrlMatchRule2, new OpenSpan.Design.ComponentIdentity("DocumentUrlMatchRule-8D5CF0E378D2510"));
		this.SetId(documentTitleMatchRule2, new OpenSpan.Design.ComponentIdentity("DocumentTitleMatchRule-8D5CF0E3799110C"));
		// 
		// Add components
		// 
	...
	internal OpenSpan.Adapters.Web.Controls.WebPage Create_ACMEwpStores(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(ACMEwpStores, new OpenSpan.Design.ComponentIdentity("WebPage-8D5CF0E446DA3CD"));
		...
		// Set designComp Ids
		// 
		this.SetId(ACMEfrmSearch, new OpenSpan.Design.ComponentIdentity("Form-8D5CF0E445F55B4"));
		this.SetId(ACMEtxtZip, new OpenSpan.Design.ComponentIdentity("TextBox-8D5CF0E44477E1E"));
		this.SetId(inputTypeMatchRule4, new OpenSpan.Design.ComponentIdentity("InputTypeMatchRule-8D5CF0E44C11A49"));
		this.SetId(elementIdMatchRule5, new OpenSpan.Design.ComponentIdentity("ElementIdMatchRule-8D5CF0E44DB5484"));
		this.SetId(ACMEbtnFindStore, new OpenSpan.Design.ComponentIdentity("Button-8D5CF0E46DD2787"));
		this.SetId(inputTypeMatchRule5, new OpenSpan.Design.ComponentIdentity("InputTypeMatchRule-8D5CF0E46F2E2D4"));
		this.SetId(elementIdMatchRule6, new OpenSpan.Design.ComponentIdentity("ElementIdMatchRule-8D5CF0E47022064"));
		this.SetId(elementIdMatchRule4, new OpenSpan.Design.ComponentIdentity("ElementIdMatchRule-8D5CF0E44A76465"));
		this.SetId(documentUrlMatchRule3, new OpenSpan.Design.ComponentIdentity("DocumentUrlMatchRule-8D5CF0E447E544D"));
		this.SetId(documentTitleMatchRule3, new OpenSpan.Design.ComponentIdentity("DocumentTitleMatchRule-8D5CF0E448F04DD"));
		// 
		// Add components
		// 
	...
	internal OpenSpan.Adapters.Web.Controls.WebPage Create_ACMEwpResults(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(ACMEwpResults, new OpenSpan.Design.ComponentIdentity("WebPage-8D5CF0F51FA0E84"));
		OpenSpan.Adapters.Web.Controls.Form Peachtree_City2715_Hwy_54_WPeachtr1;
		Peachtree_City2715_Hwy_54_WPeachtr1 = new OpenSpan.Adapters.Web.Controls.Form();
		// 
		// Peachtree_City2715_Hwy_54_WPeachtr1
		// 
		OpenSpan.Adapters.Web.Controls.Table Peachtree_City2715_Hwy_54_WPeachtre;
		Peachtree_City2715_Hwy_54_WPeachtre = new OpenSpan.Adapters.Web.Controls.Table();
		// 
		// Peachtree_City2715_Hwy_54_WPeachtre
		// 
		Peachtree_City2715_Hwy_54_WPeachtre.ElementId = "search_locator_result_table";
		Peachtree_City2715_Hwy_54_WPeachtre.Extender = null;
		Peachtree_City2715_Hwy_54_WPeachtre.ForwardObjectExplorerEvent = true;
		Peachtree_City2715_Hwy_54_WPeachtre.MatchingIndex = 0;
		...
		Peachtree_City2715_Hwy_54_WPeachtre.MatchRules.Add(elementIdMatchRule8);
		Peachtree_City2715_Hwy_54_WPeachtre.Name = "Peachtree_City2715_Hwy_54_WPeachtre";
		Peachtree_City2715_Hwy_54_WPeachtre.Schema.Id = new System.Guid("820b285d-efbd-4d0e-a63b-04bb121441d5");
		Peachtree_City2715_Hwy_54_WPeachtre.Schema.Name = "Peachtree_City2715_Hwy_54_WPeachtre";
		Peachtree_City2715_Hwy_54_WPeachtre.TagName = "TABLE";
		Peachtree_City2715_Hwy_54_WPeachtre.TargetTypeString = "OpenSpan.Adapters.Web.HtmlTableElement, OpenSpan.Adapters.Web";
		Peachtree_City2715_Hwy_54_WPeachtre.UseElementId = true;
		Peachtree_City2715_Hwy_54_WPeachtr1.Controls.Add(Peachtree_City2715_Hwy_54_WPeachtre);
		Peachtree_City2715_Hwy_54_WPeachtr1.ElementId = "form1";
		Peachtree_City2715_Hwy_54_WPeachtr1.Extender = null;
		Peachtree_City2715_Hwy_54_WPeachtr1.ForwardObjectExplorerEvent = true;
		Peachtree_City2715_Hwy_54_WPeachtr1.MatchingIndex = 0;
		...
		Peachtree_City2715_Hwy_54_WPeachtr1.MatchRules.Add(elementIdMatchRule7);
		Peachtree_City2715_Hwy_54_WPeachtr1.Name = "Peachtree_City2715_Hwy_54_WPeachtr1";
		Peachtree_City2715_Hwy_54_WPeachtr1.TagName = "FORM";
		Peachtree_City2715_Hwy_54_WPeachtr1.TargetTypeString = "OpenSpan.Adapters.Web.HtmlFormElement, OpenSpan.Adapters.Web";
		Peachtree_City2715_Hwy_54_WPeachtr1.UseElementId = true;
		ACMEwpResults.Controls.Add(Peachtree_City2715_Hwy_54_WPeachtr1);
		...
		// Set designComp Ids
		// 
		this.SetId(Peachtree_City2715_Hwy_54_WPeachtr1, new OpenSpan.Design.ComponentIdentity("Form-8D5CF0F51EE22B1"));
		this.SetId(Peachtree_City2715_Hwy_54_WPeachtre, new OpenSpan.Design.ComponentIdentity("Table-8D5CF0F51E2370F"));
		this.SetId(elementIdMatchRule8, new OpenSpan.Design.ComponentIdentity("ElementIdMatchRule-8D5CF0F522ED3F6"));
		this.SetId(elementIdMatchRule7, new OpenSpan.Design.ComponentIdentity("ElementIdMatchRule-8D5CF0F522085D5"));
		this.SetId(documentUrlMatchRule4, new OpenSpan.Design.ComponentIdentity("DocumentUrlMatchRule-8D5CF0F5204FF48"));
		this.SetId(documentTitleMatchRule4, new OpenSpan.Design.ComponentIdentity("DocumentTitleMatchRule-8D5CF0F5212378E"));
		// 
		// Add components
		// 
		components.Add(Peachtree_City2715_Hwy_54_WPeachtr1);
		components.Add(Peachtree_City2715_Hwy_54_WPeachtre);
	...
	internal OpenSpan.Adapters.Web.Controls.Form Create_Peachtree_City2715_Hwy_54_WPeachtr1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		components = new System.Collections.Generic.List<System.ComponentModel.IComponent>();
		OpenSpan.Adapters.Web.Controls.Form Peachtree_City2715_Hwy_54_WPeachtr1 = new OpenSpan.Adapters.Web.Controls.Form();
		this.SetId(Peachtree_City2715_Hwy_54_WPeachtr1, new OpenSpan.Design.ComponentIdentity("Form-8D5CF0F51EE22B1"));
		OpenSpan.Adapters.Web.Controls.Table Peachtree_City2715_Hwy_54_WPeachtre;
		Peachtree_City2715_Hwy_54_WPeachtre = new OpenSpan.Adapters.Web.Controls.Table();
		// 
		...
		// Result
		// 
		return Peachtree_City2715_Hwy_54_WPeachtr1;
	}
	
	internal OpenSpan.Adapters.Web.Controls.Table Create_Peachtree_City2715_Hwy_54_WPeachtre(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		components = new System.Collections.Generic.List<System.ComponentModel.IComponent>();
		OpenSpan.Adapters.Web.Controls.Table Peachtree_City2715_Hwy_54_WPeachtre = new OpenSpan.Adapters.Web.Controls.Table();
		this.SetId(Peachtree_City2715_Hwy_54_WPeachtre, new OpenSpan.Design.ComponentIdentity("Table-8D5CF0F51E2370F"));
		Peachtree_City2715_Hwy_54_WPeachtre.ElementId = "search_locator_result_table";
		Peachtree_City2715_Hwy_54_WPeachtre.Extender = null;
		Peachtree_City2715_Hwy_54_WPeachtre.ForwardObjectExplorerEvent = true;
		...
		// Result
		// 
		return Peachtree_City2715_Hwy_54_WPeachtre;
	}
